"""
lib/messages.py — Teks & Pesan Terpusat Kotabi Bot
====================================================
Semua string yang tampil ke user disimpan di sini.
Kalau mau ubah teks → cukup edit file ini, tidak perlu buka cog satu per satu.

Penggunaan:
    from lib.messages import Msg

    await interaction.response.send_message(Msg.VIP_ONLY, ephemeral=True)
    await interaction.followup.send(Msg.bookmark_saved(channel.mention, jump_url))
"""
...
# ============================================================================
# KELAS PESAN STATIS
# Konstanta string yang tidak butuh parameter dinamis.
# ============================================================================
...
class Msg:
    ...
    # ============================================================================
    # PESAN DINAMIS (fungsi, butuh parameter)
    # ============================================================================
