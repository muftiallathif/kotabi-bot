"""
lib/grants/engine.py — Grant Engine v1
=======================================
...
MENAMBAH GRANT TYPE BARU (contoh: badge, coupon, xp):
    1. Buat lib/grants/handlers/badge.py
...
from lib.membership.service import GrantResult, MembershipService
from lib.grants.handlers.membership import MembershipGrantHandler
from lib.grants.handlers.point import PointGrantHandler
