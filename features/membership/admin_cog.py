"""
features/membership/admin_cog.py — Membership System v1 (Discord Layer)
==========================================================
...
Semua logic bisnis ada di:
  - features/membership/support/service.py
  - features/membership/support/grants/engine.py
...
from features.membership.support.grants.engine import ApplyResult, GrantEngine
...
# guild_id, channel, grace period, dan moderator role dibaca lewat shared/config.py
# (single source of truth untuk membership_settings.yml), bukan baca ulang
...
class Membership(commands.Cog):
    ...
    async def grant_trial(self, interaction: discord.Interaction, user: discord.User):
        ...
        from features.membership.support.grants.engine import ApplyResult as AR
        ar = AR()
