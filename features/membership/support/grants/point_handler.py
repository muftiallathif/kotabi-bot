"""
features/membership/support/grants/point_handler.py — Grant Handler: Point
================================================================================
(Dulu lib/grants/handlers/point.py — di-flatten & rename sesuai rencana
restrukturisasi: handlers/point.py -> grants/point_handler.py)
