"""
features/gatekeeper/support/journey_rules.py
================================================
...
# (sama dengan logika di gatekeeper_cog.py yang sudah ada)
...
def get_next_sunday_midnight(dt: datetime) -> datetime:
    ...
    Dipakai oleh:
    - features/gatekeeper/support/journey_rules.py (calculate_quiz_availability, build_quiz_info)
    - features/gatekeeper/gatekeeper_cog.py (is_on_cooldown, is_on_cooldown_create, register_quiz_attempt, dst)
