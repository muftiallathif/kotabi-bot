...
my_bot = KotabiBot(command_prefix=COMMAND_PREFIX, features_folder=FEATURES_FOLDER, path_to_db=PATH_TO_DB)
...
if __name__ == "__main__":
    ...
    parser.add_argument("cogs", nargs="*", help="List of cog filenames to load (e.g. gatekeeper_cog admin_cog), without .py extension")
